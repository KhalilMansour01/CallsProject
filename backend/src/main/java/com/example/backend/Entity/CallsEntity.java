...
public class CallsEntity {
    @Id
    @Column(name = "call_no")
    private BigDecimal call_no;

    @Column(name = "c_code", nullable = false)
    private BigDecimal c_code;

    @Column(name = "e_code")
    private BigDecimal e_code;
    ...
    public void setId(BigDecimal call_no) {
        this.call_no = call_no;
    }

    public BigDecimal getC_code() {
        return c_code;
    }

    public void setC_code(BigDecimal c_code) {
        this.c_code = c_code;
    }

    public BigDecimal getE_code() {
        return e_code;
    }

    public void setE_code(BigDecimal e_code) {
        this.e_code = e_code;
    }
    ...
    public LocalTime getReq_time() {
        return req_time;
    }

    public void setReq_time(LocalTime req_time) {
        this.req_time = req_time;
    }

    public BigDecimal getRp_code() {
        return rp_code;
    }

    public void setRp_code(BigDecimal rp_code) {
    ...
    public LocalTime getResp_time() {
        return resp_time;
    }

    public void setResp_time(LocalTime resp_time) {
    ...
    public LocalTime getTime_left() {
        return time_left;
    }

    public void setTime_left(LocalTime time_left) {
    ...
    public void setF_cat(String f_cat) {
        this.f_cat = f_cat;
    }
    ...
    public String getAct_rem1() {
        return act_rem1;
    }

    public void setAct_rem1(String act_rem1) {
        this.act_rem1 = act_rem1;
    }

    public String getAct_rem2() {
        return act_rem2;
    }

    public void setAct_rem2(String act_rem2) {
        this.act_rem2 = act_rem2;
    }

    public String getAct_rem3() {
        return act_rem3;
    }

    public void setAct_rem3(String act_rem3) {
        this.act_rem3 = act_rem3;
    }

    public String getAct_rem4() {
        return act_rem4;
    }

    public void setAct_rem4(String act_rem4) {
        this.act_rem4 = act_rem4;
    }
}
